...
function installProperties(element) {
  for (const prop of ['accept', 'max', 'min', 'pattern', 'placeholder', 'step']) {
  ...
  for (const prop of ['multiple', 'required', 'readOnly']) {
    installProperty(element, prop, {
  ...
  for (const prop of ['minLength', 'maxLength']) {
    installProperty(element, prop, {
...
function uninstallProperties(element) {
  for (const prop of ['accept', 'max', 'min', 'pattern', 'placeholder', 'step', 'multiple', 'required', 'readOnly', 'minLength', 'maxLength']) {
