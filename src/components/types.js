...
export const inputChecked = ['email', 'date', 'month', 'week', 'time', 'datetime', 'datetime-local', 'number', 'range', 'color'];
...
export const validationCandidates = ['checkbox', 'color', 'file', 'image', 'radio', 'submit'].concat(numbers, text);
